<?php
abstract class _Http_Client_Adapter
{
    /**
     * 方法名
     *
     ...
     * @var string
     */
    protected $method = _Http_Client::METHOD_GET;
    ...
    public function send($url)
    {
        ...
        if (!empty($params['host'])) {
            ...
            throw new _Http_Client_Exception('Unknown Host', 500);
        }

        if (!in_array($params['scheme'], array('http', 'https'))) {
            throw new _Http_Client_Exception('Unknown Scheme', 500);
        }
